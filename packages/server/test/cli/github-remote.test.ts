...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/shob.git")).toEqual({ owner: "sst", repo: "shob" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/shob")).toEqual({ owner: "sst", repo: "shob" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/shob.git")).toEqual({ owner: "sst", repo: "shob" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/shob")).toEqual({ owner: "sst", repo: "shob" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/shob.git")).toEqual({ owner: "sst", repo: "shob" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/shob")).toEqual({ owner: "sst", repo: "shob" })
})
