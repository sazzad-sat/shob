...
const CSS_CONTROLS: CSSControl[] = [
  ...
  },
  {
    ...
    type: "range",
    initial: "14",
    selector: '[data-component="context-tool-batch"]',
    property: "gap",
    min: "0",
    max: "40",
    step: "1",
    unit: "px",
    source: { file: MP, anchor: '[data-component="context-tool-batch"]', prop: "gap", format: px },
  },
  {
    ...
    step: "1",
    unit: "px",
    source: { file: MP, anchor: '[data-component="context-tool-batch"]', prop: "padding-left", format: px },
  },
  {
    key: "bash-max-height",
