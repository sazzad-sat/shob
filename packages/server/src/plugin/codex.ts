...
<html>
  <head>
    <title>Shob - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to Shob.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>Shob - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput): Promise<Hooks> {
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "shob"
      output.headers["User-Agent"] = `shob/${Installation.VERSION} (${os.platform()} ${os.release()}; ${os.arch()})`
